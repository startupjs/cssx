...
export type CssxDiagnosticCode = 'CSS_SYNTAX_ERROR' | 'UNSUPPORTED_SELECTOR' | 'UNSUPPORTED_AT_RULE' | 'INVALID_DECLARATION' | 'UNRESOLVED_VARIABLE' | 'VARIABLE_CYCLE' | 'VARIABLE_DEPTH_LIMIT' | 'UNSUPPORTED_INTERPOLATION_POSITION' | 'INVALID_INTERPOLATION_VALUE' | 'UNSUPPORTED_CALC' | 'UNSUPPORTED_BACKGROUND_IMAGE' | 'UNSUPPORTED_BACKGROUND_SHORTHAND'
